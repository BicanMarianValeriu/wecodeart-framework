...
const Accordion = ({
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("button", {
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()(['wca-accordion-component', {
      expanded
    }]),
    onClick: toggle
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("h4", {
    className: "wca-accordion-component__title"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("span", null, label), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(Icon, {
    size: 30,
    icon: expanded ? _wordpress_icons__WEBPACK_IMPORTED_MODULE_2__["chevronUp"] : _wordpress_icons__WEBPACK_IMPORTED_MODULE_2__["chevronDown"]
  }))), expanded && children);
};
...
/* harmony import */ var _common_Accordion__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../common/Accordion */ "./src/js/customizer/common/Accordion.js");
/* harmony import */ var _common_Color__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../common/Color */ "./src/js/customizer/common/Color.js");
...
const PaletteForm = ({
  ...
  const setBasePalette = ({
    target: {
      value
    }
  }) => setPaletteFrom(value);

  const paletteExists = () => choices.filter(({
    slug
  }) => camelCase(newPaletteName) === slug).length > 0;
  ...
  if (!isAdding) {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
      ...
      isSmall: true,
      isSecondary: true,
      icon: _wordpress_icons__WEBPACK_IMPORTED_MODULE_1__["plusCircleFilled"],
      iconSize: 16,
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
  ...
  }, __('Extend from:', 'wecodeart')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("select", {
    value: paletteFrom,
    ...
    isDestructive: true,
    onClick: toggleAdding
  }, __('Cancel', 'wecodeart')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(Button, {
    isSmall: true,
    icon: _wordpress_icons__WEBPACK_IMPORTED_MODULE_1__["plusCircleFilled"],
    iconSize: 16,
    isPrimary: true,
...
const PaletteSelector = ({
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    ...
    }), isOpenModal && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(Modal, {
      isDismissible: false,
      className: "wecodeart-palette-options__item-modal",
      title: sprintf( // translators: %s - name of palette that will be deleted.
      __('Are you sure you want to delete the %s palette?', 'wecodeart'), choices.filter(({
        slug
      }) => willDelete === slug).pop().label)
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("p", null, __('If this is the currently active palette, the current palette will be switched to the Base one.', 'wecodeart')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
      className: "actions"
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(Button, {
      isPrimary: true,
      icon: "trash",
      onClick: deletePalette
    }, __('Delete', 'wecodeart')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(Button, {
      isSecondary: true,
      onClick: () => {
        setIsOpenModal(false);
        setWillDelete('');
      ...
      className: classnames__WEBPACK_IMPORTED_MODULE_1___default()(['wecodeart-palette-options__button', {
        active: value === slug
      }]),
      onClick: e => {
        e.preventDefault();
...
/* harmony import */ var _Selector__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Selector */ "./src/js/customizer/controls/palette/Selector.js");
/* harmony import */ var _Colors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Colors */ "./src/js/customizer/controls/palette/Colors.js");
/* harmony import */ var _Form__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Form */ "./src/js/customizer/controls/palette/Form.js");
...
const Component = ({
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, label && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("span", {
    className: "customize-control-title"
  }, label), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_Selector__WEBPACK_IMPORTED_MODULE_2__["default"], objectProps), allowAdd && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_Form__WEBPACK_IMPORTED_MODULE_4__["default"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({}, objectProps, {
    disabled: choices.length > 4
  })), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_Colors__WEBPACK_IMPORTED_MODULE_3__["default"], objectProps));
};
