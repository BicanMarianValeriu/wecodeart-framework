...
const Plugin = _ref => {
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(CardHeader, null, title && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", {
    className: "m-0"
  }, title), getBadge(source)), (description || more) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(CardBody, null, description && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, description), more && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(ExternalLink, {
    className: "fw-bold text-decoration-none",
    href: more
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "me-1"
  }, __('Learn more', 'wecodeart'))))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(CardFooter, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(HStack, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }) : __('Plugin not detected.', 'wecodeart')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Button, {
    className: "button",
    isPrimary: true,
    icon: installLoading && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Spinner, null),
...
/* harmony import */ var _Components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Components */ "./src/js/admin/plugins/Components.js");
...
const Options = _ref => {
  ...
  const hasRecommendedPlugins = plugins.filter(_ref3 => {
    let {
      recommended,
      ...rest
    } = _ref3;
    return recommended && allPlugins.includes(getPluginDir(rest)) === false;
  });
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, hasRecommendedPlugins.length ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
    className: "components-notice is-info flex-column align-items-start m-0 mb-3"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("p", null, sprintf(__('Your theme has recommended the following plugins: %s. Would you like to install them?', 'wecodeart'), hasRecommendedPlugins.map(_ref4 => {
    let {
      title
    } = _ref4;
    return title;
    ...
    onClick: () => {
      ...
      formData.append('action', 'wca_manage_plugins');
      formData.append('type', 'install');
      formData.append('plugins', JSON.stringify(hasRecommendedPlugins.map(_ref5 => {
        let {
          slug,
          source
        } = _ref5;
    ...
    disabled: reloading
  }, reloading ? '' : __('Install', 'wecodeart')))) : null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
    className: "grid grid--installables mb-3"
  }, plugins.map(props => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Components__WEBPACK_IMPORTED_MODULE_2__.Plugin, (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, props, extraPluginProps)))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(Button, {
    className: "button",
    isPrimary: true,
    icon: reloading && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(Spinner, null),
    onClick: () => {
