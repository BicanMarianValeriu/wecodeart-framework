...
wecodeart( 'markup' )->SVG::add_icon( 'key', [
    'viewBox'	=> '0 0 512 512',
...
wecodeart( 'markup' )->SVG::add_icon( 'unlock', [
    'viewBox'	=> '0 0 318 512',
...
<form action="<?php echo esc_url( $action ); ?>" method="post">
    ...
    <div class="input-group"> 
        <span class="input-group-text"><?php 
            ...
            wecodeart( 'markup' )->SVG::render( 'unlock', [
                'class' => 'fa-fw'
            ] );
        ...
        wecodeart_input( 'button', [
            'label' => wecodeart( 'markup' )->SVG::compile( 'key' ) . sprintf( '<span>%s</span>', esc_html__( 'Unlock', 'wecodeart' ) ),
        ] );
