    ...
    */
    'installers' => [
        'modules' => [
            ...
            [
                'slug'          => 'BicanMarianValeriu/wca-tabs',
                'title'         => esc_html__( 'WCA: Tabs', 'wecodeart' ),
                'description'   => esc_html__( 'Extends Gutenberg editor with an tabs block built on WP Interactivity API.', 'wecodeart' ),
                'more'          => 'https://github.com/BicanMarianValeriu/wca-tabs/',
                'source'        => 'github',
                'version'       => '1.0.2',
                'destination'   => 'tabs',
                'type'          => 'module',
            ...
            [
                'slug'          => 'BicanMarianValeriu/wca-smoothscroll',
                'title'         => esc_html__( 'WCA: Smooth Scroll', 'wecodeart' ),
                'description'   => esc_html__( 'Lightweight extension for adding smoothscroll on your site. Super flexible and customizable.', 'wecodeart' ),
                'more'          => 'https://www.wecodeart.com/integrations/smoothscroll/',
                'source'        => 'github',
                'version'       => '1.0.0',
