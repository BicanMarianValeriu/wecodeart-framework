 ...
 * @subpackage 	Support\CF7\Modules
...
Class Modules implements \ArrayAccess {
    ...
    public function set( $key, $value = null ) {
        ...
        foreach ( $keys as $key => $value ) {
            $this->items[$key] = apply_filters( "wecodeart/cf7/modules/set/{$key}", $value );
        }
	}
    ...
    public function get( $key, $default = null ) {
        ...
        return apply_filters( "wecodeart/cf7/modules/get/{$key}", $this->items[$key] );
    }
