...
<div class="wp-block-query">
    ...
    <!-- wp:cover {"useFeaturedImage":true,"dimRatio":70,"overlayColor":"primary","contentPosition":"bottom center","className":"rounded shadow-lg"} -->
    <div class="wp-block-cover has-custom-content-position is-position-bottom-center rounded shadow-lg">
