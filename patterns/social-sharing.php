...
<div class="wp-block-group">
    ...
    <!-- /wp:paragraph -->
    <!-- wp:social-links {"iconColor":"primary","iconBackgroundColor":"accent","openInNewTab":true,"size":"has-small-icon-size","namespace":"wecodeart/social-links/sharing","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|xs","left":"var:preset|spacing|xs"}}},"className":"is-style-pill-shape"} -->
