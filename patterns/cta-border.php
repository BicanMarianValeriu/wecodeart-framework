...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--xl);padding-bottom:var(--wp--preset--spacing--xl)">
    <!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|lg","right":"var:preset|spacing|gutter","bottom":"var:preset|spacing|lg","left":"var:preset|spacing|gutter"}},"border":{"color":"#dfdfdf","width":"1px"}},"className":"rounded shadow-sm","layout":{"type":"constrained"}} -->
    <div class="wp-block-group rounded shadow-sm has-border-color" style="border-color:#dfdfdf;border-width:1px;padding-top:var(--wp--preset--spacing--lg);padding-right:var(--wp--preset--spacing--gutter);padding-bottom:var(--wp--preset--spacing--lg);padding-left:var(--wp--preset--spacing--gutter)">
        ...
        <h2 class="has-text-align-center fw-300">Ready to create with <strong>WeCodeArt Framework?</strong></h2>
        <!-- /wp:heading -->
        <!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"top":"var:preset|spacing|xs"}}},"className":"fw-300"} -->
        <p class="has-text-align-center fw-300" style="margin-top:var(--wp--preset--spacing--xs)">WeCodeArt Framework is a base WP theme, Super Fast, Optimized, and ready for any shape.</p>
        <!-- /wp:paragraph -->
        ...
        <div class="wp-block-buttons">
            ...
            <div class="wp-block-button">
                <a class="wp-block-button__link has-primary-background-color has-background wp-element-button" href="#" style="border-radius:40px;padding-top:var(--wp--preset--spacing--sm);padding-right:var(--wp--preset--spacing--md);padding-bottom:var(--wp--preset--spacing--sm);padding-left:var(--wp--preset--spacing--md)">Download Now</a>
            </div>
            <!-- /wp:button -->
        </div>
        <!-- /wp:buttons -->
