 ...
 * Slug: wecodeart/cards-background
...
<div class="wp-block-group alignfull py-5" style="margin-top:0;margin-bottom:0">
    ...
    <div class="wp-block-columns are-vertically-aligned-center">
        ...
        <div class="wp-block-column is-vertically-aligned-center">
            <!-- wp:cover {"url":"https://pd.w.org/2023/01/42163d169550d5270.03657997.jpg","dimRatio":90,"overlayColor":"dark","customStyle":"selector .wp-block-cover__image-background {\n  transition: transform 2s ease-in-out\n}\nselector:hover .wp-block-cover__image-background {\n  transform: scale(1.2)\n}\n"} -->
            <div class="wp-block-cover">
                <span aria-hidden="true" class="wp-block-cover__background has-dark-background-color has-background-dim-90 has-background-dim"></span>
                ...
                <div class="wp-block-cover__inner-container">
                    ...
                    <div class="wp-block-group shadow-sm rounded" style="padding-top:var(--wp--preset--spacing--lg);padding-right:var(--wp--preset--spacing--md);padding-bottom:var(--wp--preset--spacing--lg);padding-left:var(--wp--preset--spacing--md)">
                        ...
                        <p class="has-text-align-center">Lorem ipsum dolor sit amet, consectetur adipiscing metus elit. Quisque rutrum pellentesque imperdiet. Quisque rutrum pellentesque imperdiet. Lorem ipsum dolor sit amet, consectetur adipiscing metus elit. Quisque rutrum pellentesque imperdiet.</p>
                        <!-- /wp:paragraph -->
